= Movio
Movio is a video streaming app built on Rails 4.1.9 to fulfill part of the {Firehose Project}[https://www.thefirehoseproject.com/] curriculum. The goal was to develop a platform that manages user roles and subscriptions, allows video streaming and accepts payments.
